---
layout: post
title: "JavaScript模块化规范CommonJS,AMD,CMD,ES6 Module"
categories: [开发技术]
tags: [JavaScript,模块化,模块化规范]
...
2. [CommonJS Spec 概览](http://wiki.commonjs.org/wiki/Category:Spec)
3. [CommonJS规范介绍](http://webpackdoc.com/commonjs.html)
4. [Modules规范](http://wiki.commonjs.org/wiki/Modules)
5. [Modules 1.1.1规范](http://wiki.commonjs.org/wiki/Modules/1.1.1)
6. [Package 1.0规范](http://wiki.commonjs.org/wiki/Packages/1.0)
7. [CommonJS-AMD](http://wiki.commonjs.org/wiki/Modules/AsynchronousDefinition)
8. [AMD 规范](https://github.com/amdjs/amdjs-api/wiki/AMD)
