...
4. [HTTPS, SPDY和 HTTP/2性能的简单对比](https://www.qianduan.net/a-simple-performance-comparison-of-https-spdy-and-http2/)
5. [HTTPS、SPDY和HTTP/2的性能比较](http://www.infoq.com/cn/news/2015/02/https-spdy-http2-comparison)
