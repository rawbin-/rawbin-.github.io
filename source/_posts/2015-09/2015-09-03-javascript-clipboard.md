---
layout: post
title: "JavaScript 浏览器 剪贴板操作 复制 粘贴"
...
0. [clipboard.js](https://zenorocha.github.io/clipboard.js/)
...
0. [Cut and Copy Commands](https://developers.google.com/web/updates/2015/04/cut-and-copy-commands)
0. [W3C Clipboard API and events](http://www.w3.org/TR/clipboard-apis/)
0. [Clipboard API兼容性](http://caniuse.com/#feat=clipboard)
0. [Document.execCommand兼容性](http://caniuse.com/#search=execCommand)
0. [各浏览器中 document.execCommand](http://www.w3help.org/zh-cn/causes/BX9054)
0. [Document.execCommand MDN](https://developer.mozilla.org/en-US/docs/Web/API/Document/execCommand#Browser_Compatibility)
0. [MSDN execCommand](https://msdn.microsoft.com/en-us/library/aa220275%28office.11%29.aspx)
0. [MDN execCommand](https://developer.mozilla.org/en-US/docs/Web/API/Document/execCommand#Browser_Compatibility)
0. [Using the clipboard](https://developer.mozilla.org/en-US/docs/Mozilla/Tech/XPCOM/Using_the_clipboard)
0. [Javascript: Copy To Clipboard Cross Browser](http://www.deluxeblogtips.com/2010/06/javascript-copy-to-clipboard.html)
